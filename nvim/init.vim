...
autocmd FileType go nmap <leader>c :!go test -cover<cr>
autocmd FileType go nmap <leader>t :!go test<cr>
autocmd FileType go nmap <leader>r :!go test -race<cr>
autocmd FileType go nmap <leader>b :!go test -run=XXX -bench=. -benchmem<cr>
autocmd FileType go nmap <leader>l :!gometalinter --deadline 30s<cr>
